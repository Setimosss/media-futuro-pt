...
const ChartLine = createLucideIcon("chart-line", __iconNode$z);
...
const GitCompare = createLucideIcon("git-compare", __iconNode$r);
const __iconNode$q = [
  [
    "path",
    {
...
const Grid3x3 = createLucideIcon("grid-3x3", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
...
const MousePointerClick = createLucideIcon("mouse-pointer-click", __iconNode$e);
const __iconNode$d = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
